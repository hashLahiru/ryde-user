    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
        <View style={styles.logoContainer}>
          <TouchableOpacity onPress={toggleSideMenu} accessibilityLabel="Menu">
        ...
        <TouchableOpacity 
         onPress={() => navigation.navigate('NotificationsScreen')} accessibilityLabel="Menu">
          <MaterialIcons
      ...
      >
        <View style={styles.sideMenu}>
          ...
          <View style={styles.menuItemsContainer}>
            {['Home', 'User', 'Notifications', 'Payments', 'History', 'Support', 'Logout', 'Exit'].map(
              (item, index) => (
                <Text
                  key={index}
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.banner}>
          ...
          />
          <Text style={styles.bannerText}>Ready?{'\n'}Let's Start</Text>
        ...
        <View style={styles.offerCard}>
          ...
          <View style={styles.offerDetails}>
            <Text style={styles.offerTitle}>Johnson Smithkover</Text>
            <Text style={styles.offerSubtitle}>
              Up to 10 km from Wankover city area
            </Text>
            <Text style={styles.offerInfo}>Mini sedan | 4 person</Text>
            <Text style={styles.offerValid}>Valid till : 20/11/2023</Text>
          </View>
