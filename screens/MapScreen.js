...
export default function MapScreen({ navigation }) {
 ...
 const updateRegion = (pickup, drop) => {
  ...
  const latitudeDelta = (latMax - latMin) * 1.5; // Add some padding
  const longitudeDelta = (lngMax - lngMin) * 1.5; // Add some padding
    ...
    <View style={styles.container}>
     ...
     {distance && duration && (
      <View style={styles.infoContainer}>
       ...
       <Text style={styles.infoText}>Duration: {duration.toFixed(2)} mins</Text>
      </View>
     )}
     ...
     <View style={styles.bottomSheet}>
      ...
      <View style={styles.buttonContainer}>
       ...
       <TouchableOpacity style={styles.startButton} onPress={handleFindDriver}>
